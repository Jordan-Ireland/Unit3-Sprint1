...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  ```
  The most important part of a code review for me is learning how other people would
  do something that I wouldn't have thought about. I appreciate when my peers give me
  hard criticism on what I did wrong. As a teacher of some C# coding students, I never
  give them the answer straight away and let them try to look on their own for the answer.
  I do that with my peer reviews as well, leaving notes of where they can find information
  and maybe hints on what to do or even psuedo-code.  
  ```
...
- We have an awful lot of computers here, and it gets pretty confusing with
  ...
  ```
  Containers are a great way to make sure that code runs on whatever machine regardless
  of OS. They also make sure that your code is reproducable and able to be ran
  no matter what packages the other user has installed on their personal machine.
  Google Colab and Heroku are great examples of popular sites that use containers to 
  let users interact with code they may not be able to code themselves.
  ```
